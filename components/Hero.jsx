                ...
                <div className="relative w-full grid grid-cols-2 p-16">
                    <div className="relative">
                        ...
                        <div className="relative flex py-10">
                            <Link href="#" >
                                <a className="bg-primary-500 mx-2 text-slate-600 text-lg font-semibold py-3 rounded-xl px-10">
                                    Get started free
                                </a>
                            </Link>
                            <Link href="#" >
                                <a className="bg-white mx-2 border border-slate-400/10 rounded-xl text-slate-600 text-lg font-semibold py-3 px-10 flex items-center justify-between">
                    ...
                    <div className="relative px-14 py-10 ">
                        <div className="h-4 w-4 absolute left-36 rounded-full bg-orange-400 pointer-events-none"></div>
                        <div className="transform -rotate-12 h-6 w-6 right-10 top-0 absolute bg-orange-400 pointer-events-none"></div>
                        ...
                        <div className="h-7 w-7 absolute bottom-8 left-56 rounded-full shadow-xl flex justify-center items-center bg-white pointer-events-none z-10">
